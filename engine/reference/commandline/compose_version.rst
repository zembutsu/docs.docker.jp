.. -*- coding: utf-8 -*-
.. URL: https://docs.docker.com/engine/reference/commandline/compose_version/
.. SOURCE: 
   doc version: 20.10
      https://github.com/docker/docker.github.io/blob/master/engine/reference/commandline/compose_version.md
...
Docker Compose バージョン情報を表示

.. _compose_version-usage:
...
.. list-table::
   ...
   * - ``--format`` , ``-f``
     - 
     - 出力フォーマット。値： [ ``pretty`` | ``json`` ] （デフォルト： ``pretty`` ）
   * - ``--short``
     - 
     - Compose のバージョン番号のみ表示
