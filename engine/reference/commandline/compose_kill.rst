.. -*- coding: utf-8 -*-
.. URL: https://docs.docker.com/engine/reference/commandline/compose_kill/
.. SOURCE: 
   doc version: 20.10
      https://github.com/docker/docker.github.io/blob/master/engine/reference/commandline/compose_kill.md
...
.. _compose_kill-extended-description:
...
実行中のコンテナに ``SIGKILL`` シグナルを送信し、強制停止します。次のように、オプションで各シグナルを渡せます。

.. code-block:: bash

   $ docker-compose kill -s SIGINT

.. _compose_kill-options:
