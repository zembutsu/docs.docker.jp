.. -*- coding: utf-8 -*-
.. URL: https://docs.docker.com/engine/reference/commandline/compose_port/
.. SOURCE: 
   doc version: 20.10
      https://github.com/docker/docker.github.io/blob/master/engine/reference/commandline/compose_port.md
...
.. _compose_port-extended-description:
...
.. list-table::
   ...
   * - ``--index``
     - ``1``
     - サービスに複数のレプリカがある場合、コンテナにインデックスを付ける
   * - ``--protocol``
     - ``tcp``
     - tcp か udp
