.. -*- coding: utf-8 -*-
.. URL: https://docs.docker.com/engine/reference/commandline/compose_stop/
.. SOURCE: 
   doc version: 20.10
      https://github.com/docker/docker.github.io/blob/master/engine/reference/commandline/compose_stop.md
...
.. _compose_stop-extended-description:
...
実行中のコンテナを削除せずに停止します。 ``docker compose start`` で再び開始できます。

.. _compose_stop-options:
