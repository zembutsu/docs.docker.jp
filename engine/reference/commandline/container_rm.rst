.. -*- coding: utf-8 -*-
.. URL: https://docs.docker.com/engine/reference/commandline/container_rm/
.. SOURCE: 
   doc version: 20.10
      https://github.com/docker/docker.github.io/blob/master/engine/reference/commandline/container_rm.md
      https://github.com/docker/docker.github.io/blob/master/_data/engine-cli/docker_container_rm.yaml
...
.. list-table::
   ...
   * - ``--force`` , ``-f``
     - 
     - 実行中のコンテナを（ SIGKILL を使い ）強制的に削除
   * - ``--link`` , ``-l``
     - 
     - 対象のリンクを削除
   * - ``--volumes`` , ``-v``
     - 
     - コンテナに関連付けられた :ruby:`匿名ボリューム <anonymous volume>` を削除
