# -*- coding: utf-8 -*-
#
# Docker-docs-ja documentation build configuration file, created by
...
#html_sidebars = {
#    '**': ['sidemenu.html', 'relations.html', 'sourcelink.html', 'searchbox.html'],
#}
...
htmlhelp_basename = 'Docker-docs-ja'
...
latex_documents = [
  (master_doc, 'Docker-docs-ja.tex', u'Docker-docs-ja Documentation',
   u'Docker Docs Ja Project', 'manual'),
]
...
man_pages = [
    (master_doc, 'docker-docs-ja', u'Docker-docs-ja Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Docker-docs-ja', u'Docker-docs-ja Documentation',
   author, 'Docker-docs-ja', 'One line description of project.',
   'Miscellaneous'),
]
